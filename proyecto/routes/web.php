...
Route::middleware(['web', 'App\Http\Middleware\LdapAuthMiddleware'])->group(function () {
    ...
    Route::prefix('mensajes')->middleware(CheckModuleAccess::class.':mensajeria')->group(function () {
        ...
        Route::get('/buscar-destinatarios', [MensajeController::class, 'buscarDestinatarios'])
            ->name('dashboard.mensajes.buscar-destinatarios');
    });
    ...
    Route::prefix('gestion/grupos')->name('gestion.grupos.')->group(function () {
        ...
        Route::get('/{cn}', [LdapGroupController::class, 'show'])->name('show');
...
Route::middleware(['web', 'App\Http\Middleware\LdapAuthMiddleware', 'App\Http\Middleware\AdminMiddleware'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/users/toggle-admin', [App\Http\Controllers\Admin\LdapUserController::class, 'toggleAdmin'])->name('users.toggle-admin');
...
Route::middleware(['App\Http\Middleware\LdapAuthMiddleware'])->prefix('profesor')->name('profesor.')->group(function () {
    ...
    Route::middleware(CheckModuleAccess::class.':clases')->group(function () {
